...
### ユーザー
- コーヒー豆を検索し詳細ページの情報を閲覧している際には、おそらく「この豆はどこのお店で買えるんだろう」、店舗を検索し詳細ページの情報を確認している際には「この店ではどんなコーヒー豆を販売しているんだろう」といったことをユーザーは考えるのではないかと思ったため、各詳細ページに店舗・コーヒー豆の名前を各詳細ページへのリンクとし、表示させました。s
- コーヒー豆を検索し詳細ページの情報を閲覧している際には、おそらく「この豆はどこのお店で買えるんだろう」、店舗を検索し詳細ページの情報を確認している際には「この店ではどんなコーヒー豆を販売しているんだろう」といったことをユーザーは考えるのではないかと思ったため、各詳細ページに店舗・コーヒー豆の名前を各詳細ページへのリンクとし、表示させました。
